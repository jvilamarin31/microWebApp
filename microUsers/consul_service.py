...
def get_service_config(service_name_default='users', service_port_default=5002, service_host_default='microusers'):
...
def register_service(app, service_name_default='users', service_port_default=5002, service_host_default='microusers'):
