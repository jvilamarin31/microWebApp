...
def get_service_config(service_name_default='frontend', service_port_default=5001, service_host_default='frontend'):
...
def register_service(app, service_name_default='frontend', service_port_default=5001, service_host_default='frontend'):
